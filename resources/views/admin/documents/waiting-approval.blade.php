...
<head>
    ...
    <title>Waiting Approval | Admin Panel</title>
...
<body class="min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-purple-300">✅ Waiting Approval</h1>
                <p class="text-purple-200 text-sm mt-2">Dokumen sudah selesai review, menunggu approval final</p>
            </div>
            ...
            <div class="glass p-6 rounded-2xl overflow-x-auto">
                        ...
                        <tbody class="divide-y divide-white/10">
                            @foreach($pengajuan as $item)
                                <tr>
                                    ...
                                    <td class="py-3">{{ $item->unit_kerja ?? 'N/A' }}</td>
                                    <td class="py-3">{{ $item->tanggal_berlaku?->format('d M Y') ?? 'N/A' }}</td>
                                    <td class="py-3">
                                        <span class="px-2 py-1 bg-green-600 rounded text-xs">Ready to Sign</span>
                                    </td>
                ...
                @else
                    <div class="py-8 text-center text-gray-400">
                        <p>✅ No documents waiting approval</p>
                    </div>
                @endif
            </div>

...
<head>
    ...
    <title>Draft Documents | Admin Panel</title>
...
<body class="min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-purple-300">📄 Draft Documents</h1>
                <p class="text-purple-200 text-sm mt-2">Pengajuan dokumen yang masih dalam status draft</p>
            </div>
                        ...
                        <tbody class="divide-y divide-white/10">
                            @foreach($pengajuan as $item)
                                <tr>
                                    ...
                                    <td class="py-3">
                                        <span class="px-2 py-1 bg-gray-600 rounded text-xs">{{ $item->jenis }}</span>
                                    </td>

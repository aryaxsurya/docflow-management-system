{{-- STYLE SEMENTARA UNTUK HALAMAN INI --}}
<head>
    <!-- Tailwind CDN -->
...
<div class="flex text-white min-h-screen">
    ...
    <aside class="w-64 glass min-h-screen p-6">
        ...
        <nav class="space-y-4">
            <a href="/user/dashboard" class="block hover:text-blue-400">🏠 Dashboard</a>
    ...
    <main class="flex-1 p-10">
        ...
        <div class="relative mb-10 overflow-hidden rounded-3xl shadow-xl">
            ...
            <div class="relative p-10 flex items-center gap-6 z-10">
                <div class="bg-white/20 backdrop-blur-lg rounded-2xl p-5 border border-white/30 shadow-lg">
                    <div class="text-5xl">⚙️</div>
                </div>
                <div>
                    <h1 class="text-4xl font-bold text-white mb-2">Pengaturan Akun</h1>
                    <p class="text-blue-100 text-lg">Kelola identitas dan data pribadi Anda</p>
                </div>
            </div>
        </div>
